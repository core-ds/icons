...
export const PlusSquareMediumLineMIcon: React.FC<SVGProps<
    SVGSVGElement
>> = props => (
    <svg
        role="img"
...
export default PlusSquareMediumLineMIcon;
